  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-[100%] bg-[#fff]">
        ...
        <button className="block w-[32px] h-[32px] absolute right-[15px] top-[19px] overflow-hidden indent-[-9999px] ">
      ...
      >
        <dl history-title="2024.02.01">
          ...
          >
            <button
              className="block w-[8px] h-[8px] overflow-hidden indent-[-9999px] absolute top-0 right-0
              "
            >
              <Image
                className={` ${
